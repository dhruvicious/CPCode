...
/*
You are given an integer array of length 4. You have four cards, each containing
a number in the range [1,9]. You should arrange the numbers on these cards in a
mathematical expression using the operators ['+', '-', '*', '/'] and the
...
'-' as a unary operator. For example, if cards = [1, 1, 1, 1], the expression
"-1 -1 -1 -1" is *not allowed*.
    3. You cannot concatenate numbers together.
        For example, if cards=[1, 2, 1, 2], the expression "12+12" is not valid.

Return treu of you can get such an expression that evaluates to 24, and false
otherwise.
*/

...
int32_t main() {
    ...
    vector<vector<string>> test_cases = {
        {"/a", "/a/b", "/c/d", "/c/d/e",
         "/c/f"},  // Expected: {"/a", "/c/d", "/c/f"}
        {"/x", "/x/y", "/x/y/z", "/w", "/w/x"},  // Expected: {"/x", "/w"}
        {"/home", "/home/user", "/home/user/docs", "/var",
         "/var/log"},  // Expected: {"/home", "/var"}
        {"/alpha", "/alpha/beta", "/gamma",
         "/delta"},                // Expected: {"/alpha", "/gamma", "/delta"}
        {"/a/b/c", "/a/b", "/a"},  // Expected: {"/a"}
        {"/p/q/r", "/p/q", "/p"},  // Expected: {"/p"}
        {"/z", "/z1", "/z/z1", "/z/z2", "/z1/z2"},  // Expected: {"/z", "/z1"}
        {"/data", "/data1", "/data2", "/data/backup",
         "/data2/archive"},  // Expected: {"/data", "/data1", "/data2"}
        {"/abc", "/abcd", "/abc/def", "/abcd/efg",
         "/abc/ghi"},  // Expected: {"/abc", "/abcd"}
        {"/r", "/r/s", "/r/s/t", "/r/s/t/u", "/r2",
         "/r3"},  // Expected: {"/r", "/r2", "/r3"}
    };
    Solution s;
